...
vector<_Code> KBData::getModCodes(_Mod mod)
{
  vector<_Code> codes;
...
void KBData::add_sequence(_Code code, ModBit mod, KeySymDataLinks& links, const vector<_Sym> seq, size_t seq_index)
{
...
void KBData::add_sequence(_Code code,
vector<_Sym> seq0,
vector<_Sym> seq1,
vector<_Sym> seq2,
vector<_Sym> seq3,
...
_Sym KBData::lookup(_Code code, ModBit mod)
{
  ...
  {
  case ModBit::None:
    return it->second.syms[0];
  case ModBit::Shift:
    return it->second.syms[1];
  case ModBit::Control:
    return it->second.syms[2];
  case ModBit::Control_Shift:
    return it->second.syms[4];
  case ModBit::Alt:
    return it->second.syms[3];
  case ModBit::Shift_Alt:
    return it->second.syms[6];
  case ModBit::Control_Alt:
    return it->second.syms[5];
  case ModBit::Shift_Control_Alt:
    return it->second.syms[7];
  default:
    break;
  }
...
bool KBData::lookup(TermBuffer* buffer, _Code* pCode, _Mod* pMod)
{
  *pCode = 0;
  auto* pLinks = &_root;
...
void KBData::add_code_sym(_Code code, _Sym s0, _Sym s1, _Sym s2, _Sym s3, _Sym s4, _Sym s5, _Sym s6, _Sym s7)
{
...
void KBData::add_alt_sequence(_Sym ch)
{
  _Code code;
  _Mod mod;
  TermBuffer seq;
...
KBData::KBData()
{
  ...
  add_sequence(41, { 96 }, { 126 }, { 0 }, { /*focus*/ }, { /*27*/ }, { 27, 0 }, { 27, 126 }, { 27, 30 });                                                                                                                                                                           // `
  add_sequence(2, { 49 }, { 33 }, { /*49*/ }, { 194, 177 }, { /*33*/ }, { /*27, 49*/ }, { 27, 33 }, { /*27, 33*/ });                                                                                                                                                                 // 1
  add_sequence(3, { 50 }, { 64 }, { /*0*/ }, { 194, 178 }, { /*no sym*/ }, { 194, 128 }, { 195, 128 }, { /*194, 128*/ });                                                                                                                                                            // 2
  add_sequence(4, { 51 }, { 35 }, { /*27*/ }, { 194, 179 }, { /*35*/ }, { 194, 155 }, { 194, 163 }, { /*194, 163*/ });                                                                                                                                                               // 3
  ...
  add_sequence(22, { 117 }, { 85 }, { 21 }, { 195, 181 }, { /*u mode*/ }, { 194, 149 }, { 195, 149 }, { /*u mode*/ });                                                                                                                                                               // u
  ...
  add_sequence(26, { 91 }, { 123 }, { /*27*/ }, { 195, 155 }, { /*27*/ }, { /*194, 155*/ }, { 195, 187 }, { /*194, 155*/ });                                                                                                                                                         // [
  ...
  add_sequence(46, { 99 }, { 67 }, { 3 }, { 27, 99 }, { /*3*/ }, { 27, 3 }, { 195, 131 }, { /*194, 131*/ });                                                                                                                                                                         // c
